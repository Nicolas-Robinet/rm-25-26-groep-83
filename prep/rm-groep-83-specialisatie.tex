...
\end{figure*}
Same structure as the interprofessioneel version — only the box labels changed, keeping your original phase names and short descriptions from that document. Layout, spacing, and arrow direction (right along top, down, left along bottom) are identical, so both figures will look consistent across your two papers.
